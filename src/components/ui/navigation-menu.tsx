...
/** Root: forzatamente uncontrolled */
function NavigationMenu(
  ...
  // scarta value/onValueChange per evitare controllo esterno
  const { value: _ignoredValue, onValueChange: _ignoredOnValueChange, ...props } =
    rest as any;
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        ...
        // niente deep selectors strani che cambiano ogni render
        className
      )}
      {...props}
    />
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        ...
        "hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:outline-1",
