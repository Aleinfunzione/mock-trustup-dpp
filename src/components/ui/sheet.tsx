  ...
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        side === "right" && "inset-y-0 right-0 w-3/4 sm:max-w-lg data-[state=open]:slide-in-from-right data-[state=closed]:slide-out-to-right",
        side === "left" && "inset-y-0 left-0 w-3/4 sm:max-w-lg data-[state=open]:slide-in-from-left data-[state=closed]:slide-out-to-left",
