...
import ProductList from "@/components/products/productList"; // rispetta il casing del repo
import ProductForm from "@/components/products/ProductForm";  // il form include la UI guidata degli attributi

/**
 * Creator → Prodotti
 * - toggle "Nuovo prodotto" con ProductForm inline
 * - elenco prodotti con azione "Apri"
 */
